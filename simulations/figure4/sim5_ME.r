...
for (i in 1:100) {
  ...
  set.seed(49 + 2*i)
  dat <- set.data(5000, 5, 1, prob.y.clust, 1, sqrt(0.15))
  ...
  newdat <- data.frame(x1 = dat$x1,
                       ...
                       z8 = rep(nz[1,8], 5000),
                       z9 = rep(nz[1,9], 5000),
                       z10 = rep(nz[1,10], 5000),
                       z11 = rep(nz[1,11], 5000),
                       z12 = rep(nz[1,12], 5000),
                       z13 = rep(nz[1,13], 5000),
                       z14 = rep(nz[1,14], 5000),
                       z15 = rep(nz[1,15], 5000),
                       z16 = rep(nz[1,16], 5000),
                       z17 = rep(nz[1,17], 5000),
                       z18 = rep(nz[1,18], 5000),
                       z19 = rep(nz[1,19], 5000),
                       z20 = rep(nz[1,20], 5000),
                       tp  = rep(pt, 5000),
                       id = 1:5000)
...
save(l1.me, l2.me, file = "./output/thin/sim5.me.Rdata")
